...
const WeatherCard = () => {
    ...
    return (
        <div className='flex flex-col gap-6 bg-white/60 backdrop-blur-md rounded-xl p-8 min-w-sm min-h-fit py-10  text-center text-gray-900'>
            <div className='flex items-center justify-center gap-4 w-full'>
                <input type='text' value={searchCity} onChange={(e) => { setSearchCity(e.target.value) }} placeholder="Search city" className='flex-1 rounded-full p-1 pl-4 pb-2 bg-white text-xl text-orange-800' onKeyDown={handleEnterKey} />
